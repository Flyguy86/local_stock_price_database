...
# Find end
# The end of the function is distinct. It ends with return HTMLResponse(html)
# and is followed by 'live_task: asyncio.Task | None = None'
...
# Backtrack from end_marker to find the last return statement of the function
# The end_marker is at the start of global variable declaration.
# The dashboard function content ends right before that.
# We should replace everything from start_idx up to end_idx (exclusive)
# BUT we need to be careful about newlines.
